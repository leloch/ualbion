...
$err = 'F:\Dev\albion\ualbion\_narr_err.txt'
...
function Launch(){
  ...
  Start-Process -FilePath $exe -ArgumentList '-d3d','--harness-http','7878','--mute' -WorkingDirectory $wd -RedirectStandardError $err -RedirectStandardOutput 'F:\Dev\albion\ualbion\_narr_out.txt'
