...
> pattern, one detail unverified. This file is owned by agent 5B; companion to docs/re/RE_COMBAT.md.
...
("Cast school 5/6") that docs/re/RE_COMBAT.md's punch-list already corrected for the action vtable.
...
## Corrections to docs/re/RE_COMBAT.md claims (do not edit that file from this agent)
