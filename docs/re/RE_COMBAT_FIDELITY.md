...
that docs/re/RE_COMBAT.md had tagged INFERRED. **Headline result: all three were ALREADY decoded
correctly in docs/re/RE_COMBAT.md's later "CONFIRMED" sections (lines ~1990-2226) and the remake
...
docs/re/RE_COMBAT.md Item 1 (lines ~1295, 1325) were misreadings of the projectile
...
notes from docs/re/RE_COMBAT.md Item-1 rows 1295 & 1325 — superseded.)
...
The earlier "×1000/×250" tag at docs/re/RE_COMBAT.md ~line 1310/2205 confused the cluster spawn
...
docs/re/RE_COMBAT.md line 2005's correction.
...
- The frost/death-immune class bit is `0x80` (shared with the crit-immunity bit per
  docs/re/RE_COMBAT.md line 2224); GoddessWrath and KamulosGaze both exclude it.
