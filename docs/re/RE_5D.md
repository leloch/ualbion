...
> radare2 against `albion_aaa` (MAIN.EXE, DOS LE). Status tags as in docs/re/RE_NOTES.md:
...
1. docs/re/RE_NOTES.md automap section says NPC state base "~0x159c5c" — the slot stride base is
