...
> file addresses radare2 prints. Companion: `_RE_3D_MOVEMENT.md` (the DISCRETE step path, well-documented
...
path** documented in `_RE_3D_MOVEMENT.md §4`: set facing to `(facing±1)&3` (90°) or `(facing±2)&3` (180°), then
