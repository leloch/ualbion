# _RE_CHEST_TRAP.md — The EXACT source of Albion's "chest is trapped" flag

Follow-up RE pass to settle the one item `_RE_FIDELITY2.md` left unconfirmed: **where does the
...
### The pick + trap-fire code — `door.c` `0x5ab33` (re-confirmed, matches `_RE_FIDELITY2.md`)
